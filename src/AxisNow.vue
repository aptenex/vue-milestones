<template lang="html">
  ...
  <div class="axis-now">
    ...
    <div class="arrow" :style="arrowStyles">
      <div ref="nowLabel" :style="nowTransform + nowLabel" class="now-label">{{ date | toHuman }} ({{ date | absoluteDifference }})</div>
    </div>
  </div>
  ...
  .axis-now {
    ...
    .bar {
      ...
      background-image: linear-gradient(
        90deg, @nowBgStart, @nowBgEnd 60%, transparent 60%, transparent 100%
      );
